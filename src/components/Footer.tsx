        ...
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <p className="mt-3 max-w-xs text-sm leading-relaxed text-foreground/70">
              Backend developer building robust APIs with Go and Java with framework Gin, Fiber, GORM, Spring Boot, plus Docker for DevOps.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="mt-3 space-y-2 text-sm text-foreground/70">
              <li>
                <a href="mailto:bayu190903@gmail.com" className="transition-colors hover:text-accent">
                  bayu190903@gmail.com
                </a>
              </li>
              <li>Indonesia</li>
            ...
            <div className="mt-3 flex items-center gap-3">
              {socialLinks.map((link) => (
                <a
                  ...
                  className="flex h-9 w-9 items-center justify-center rounded-lg text-foreground/70 transition-colors hover:bg-foreground/10 hover:text-accent"
                >
                  {link.icon}
                </a>
              ))}
